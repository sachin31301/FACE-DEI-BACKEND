...
# * ---------- DATABASE CONFIG --------- *
DATABASE_USER = os.environ.get('DATABASE_USER','sachin_user')
DATABASE_PASSWORD = os.environ.get('DATABASE_PASSWORD','pass')
DATABASE_HOST = os.environ.get('DATABASE_HOST','127.0.0.1')
DATABASE_PORT = os.environ.get('DATABASE_PORT','5000')
DATABASE_NAME = os.environ.get('DATABASE_NAME','myname')
